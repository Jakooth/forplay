...
<head>
  ...
  <script src="/jslib/jquery.mobile.custom.min.js" type="text/javascript"></script>
  <script src="/jslib/video-js/video.js" type="text/javascript"></script>
  <script src="/jslib/video-js/vjs.vimeo.js" type="text/javascript"></script>
  ...
  <script src="/jslib/i18nextXHRBackend.min.js" type="text/javascript"></script>
  <script src="/jslib/i18nextBrowserLanguageDetector.min.js" type="text/javascript"></script>
  <!--FORPLAY
...
<body aria-busy="true">
  <header>
    <h1>
      <a href="/">
        <img id="forPlay" class="svg" src="/assets/forplay.svg" alt="Forplay&reg;" />
      </a>
      <a href="/">
        <img id="forLife" class="svg" src="/assets/forlife.svg" alt="Forlife&reg;" /> </a>
    </h1>
    ...
    <section class="nav-set">
      ...
      <nav>
        ...
        <ul>
          <li>
            <a href="/portals/video">Видео</a>
          </li>
          <li>
            <a href="/portals/review">Ревюта</a>
          </li>
          <li>
            <a href="/portals/feature">Мнения</a>
          </li>
          <li>
            <a href="http://www.gamersvoiceshop.com/" target="_blank">GVS</a>
          </li>
          <li>
            <a href="http://forplay.bg/forums/" target="_blank">Форум</a>
          </li>
          <li>
            <a href="/articles/games/video/313/forplaybg">Реклама</a>
          </li>
        </ul>
      </nav>
      <div class="search" role="search">
        ...
        <form method="get" action="#search">
          ...
          <input type="search" placeholder="пример Diablo, Диабло, 300" name="search" id="search" />
      ...
      <div class="user" role="region">
        ...
        <button id="userLogin" type="button" aria-pressed="false">
          <i>Наздраве, </i>
          <b>непознат</b>
        </button>
      </div>
    ...
    <article id="read" aria-hidden="true">
      ...
      <footer id="comment" class="comment-set" aria-busy="true">
        ...
        <form id="sendCommentForm" aria-hidden="true">
          ...
          <div role="textbox" tabindex="0" contenteditable="true" aria-multiline="true" aria-readonly="false"></div>
          <div role="toolbar">
            <button data-icon="send" type="button">
              <span>Добави</span>
            </button>
            <button data-icon="clear" type="button">
              <span>Изчисти</span>
            </button>
            <button data-icon="bold" type="button">
              <span>Болд</span>
            </button>
            <button data-icon="italic" type="button">
              <span>Италик</span>
            </button>
          </div>
        </form>
  ...
  <section id="userProfile" class="profile" aria-hidden="true">
    <form>
      <button id="profileClose" type="button">
        <span>Затвори</span>
      </button>
      <button id="profileChange" type="button" aria-pressed="false">
        <span>Смени профила</span>
      </button>
      <h1>Моят профил</h1>
  ...
  <footer>
    <p>&copy; Copyright 2015
      <a href="/articles/games/news/18/castle-design">Castle Design Ltd.</a>
    </p>
